  ...
  return (
    <>
      <button
        ...
        className="btn-label flex w-full shrink-0 cursor-pointer items-center justify-center gap-2 rounded-full btn-secondary px-5 py-2.5 sm:w-auto sm:justify-start"
      >
        <svg
          viewBox="0 0 16 16"
          className="h-3 w-3"
